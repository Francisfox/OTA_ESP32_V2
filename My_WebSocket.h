#ifndef _My_WebSocket_
#define _My_WebSocket_
...
boolean LEDonoff = false;                             //Criando variavel boeana iniciando com valor falso.
String JSONtxt;                                       // Criando as strings
String LEDswitch = "OFF";

static const char webSiteCont[] PROGMEM = R"=====(
<!DOCTYPE HTML>
<HTML>
  ...
  <head>
    ...
    function InitWebSocket(){
      ...
      websock.onmessage = function(evt){
        ...
        if(JSONobj.LEDonoff == 'ON'){
          document.getElementById('btn1').style.background = '#FFA200';
          document.getElementById('btn1').style["boxShadow"] = "0px 0px 0px 8px #FFA200";
        }else{
...
void Evento_server_MyWebSocket(){  
  if (LEDonoff == true){
    LEDswitch = "ON";
